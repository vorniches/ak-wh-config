...
# Место на складе
current_free_space = 120     # свободное место в м²
...
# Расчёт для пайчарта
used_space = total_space - current_free_space
chart_data = [used_space, current_free_space]

# Результат
RESULT = {
    "title": "Свободное место на складе",
    "value": current_free_space,
    "status": status,
    "chart_type": "pie",
    "chart_data": chart_data,
    "category": "Логистика",
    "alerts": [
        f"Места {label} — {current_free_space} м²"
    ],
    "meta": {
        "unit": "м²",
        "checked_at": "now"
